...
int main()
{
    ...
    //SFX
    //Para sfx tem que usar 64 - 255 pq o resto eh reservado para musica
    XGM_setPCM(SFX_FALL, sfx_fall, sizeof(sfx_fall));
    XGM_setPCM(SFX_FALL_MONO, sfx_fall_mono, sizeof(sfx_fall_mono));
...
static void joyEvent(u16 joy, u16 changed, u16 state)
{
    ...
    {
        //prioridade vai de 0 ate 15
        //primeiro canal geralmente eh pra musica
        XGM_startPlayPCM(SFX_FALL, 15, SOUND_PCM_CH2);
    ...
    if (changed & state & BUTTON_B)
    {
        //prioridade vai de 0 ate 15
        //primeiro canal geralmente eh pra musica
        XGM_startPlayPCM(SFX_FALL_MONO, 15, SOUND_PCM_CH3);
    }
}
